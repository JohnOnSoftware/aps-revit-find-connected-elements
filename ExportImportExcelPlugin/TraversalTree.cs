...
namespace ExportMEPSystemGraphs
{
    ...
    public class TreeNode
    {
          ...
          string json_kids)
        {
            return string.Format(
              ...
              id, MEPSystemHandler.NodeLabelTag, label, json_kids);
        }
          ...
          string parent_id)
        {
            ...
            string json = string.Format(
              ...
              MEPSystemHandler.NodeLabelTag, GetName(e),
              parent_id);
    ...
    public class TraversalTree
    {
        ...
        /// </summary>
        Dictionary<long, int> _visitedElementCount;
        #endregion
        ...
        public TraversalTree(MEPSystem system)
        {
            ...
            _visitedElementCount = new Dictionary<long, int>();
        }
        #endregion // Constructor
        ...
        private void AppendChildren(TreeNode elementNode)
        {
            ...
            Console.WriteLine(element.Id.Value.ToString());
